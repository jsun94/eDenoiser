#ifndef DEINCEPTION_H
#define DEINCEPTION_H
...
void get_submodule_de_inception(torch::jit::script::Module module, Net &child);
void *predict_de_inception(Net *input);
void forward_de_inception(th_arg *th);
void *predict_warm_de_inception(Net *input);
